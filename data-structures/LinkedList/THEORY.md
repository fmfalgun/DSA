...
- [Recursion](../non-450/Recursion/THEORY.md) - Many linked list problems use recursion
- Pointers/References

### Related Data Structures:
- [Stacks](../Stack/) - Can be implemented with linked lists
- [Queues](../Queue/) - Can be implemented with linked lists
- [Hash Tables](../non-450/HashTables/THEORY.md) - For optimizing linked list problems
...
- [Recursion](../non-450/Recursion/THEORY.md) - Traversal and manipulation
